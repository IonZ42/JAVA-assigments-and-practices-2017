...
public class CheckingAccount extends Account{
	...
	public void withdraw(double amt) throws OverdraftException {
		if(amt<=super.getBalance()){
			...
			if(isProtected) {throw new OverdraftException
				("Exception: Insufficient funds for overdraft protection   Deficit: ",amt);}
			else{throw new OverdraftException("Exception: No overdraft protection   Deficit: ",amt);}}}
}