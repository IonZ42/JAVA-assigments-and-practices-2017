...
public class TestBanking {
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    System.out.println("\n【Sorted customers report is in step10output.txt】\n【Balance limited search result is in step10output2.txt】\n");
    File inputf=new File("step10input.txt");
    if(inputf.exists()) {
    	try(
    			Scanner in=new Scanner(inputf);
        		)
    	{
    		//任务1：Create bank customers and their accounts from account section of step10input.txt
    ...
    //Generate a report, write to step10output.txt which location is same as step10input.txt
    CustomerReport cr=new CustomerReport();
    cr.generateReport();
    cr.reportSearchResult(200);
   }
}