...
public class FixedLengthStringIO {
  private static FixedLengthStringIO fl;
  private FixedLengthStringIO() {}
  
  public static FixedLengthStringIO getFixedLengthStringIO() {if(fl==null) {fl=new FixedLengthStringIO();}return fl;}
