...
//		//【不可编辑】
		...
		/******************************************RAF区***********************************************/
//		final HBox hbr=new HBox();
//		vbox3.getChildren().add(hbr);
		/******************************************RAF区完***********************************************/
	...
	public void read() throws FileNotFoundException {
	    ...
	    File inputf=new File("step13input.txt");
	    if(inputf.exists()) {
	    	try(
	    			Scanner in=new Scanner(inputf);
	        		)
	    	{
	    	    // 任务1：Create bank customers and their accounts from account section of step13input.txt
	        	...
	        	//任务2：Demonstrate behavior of various account types according to transactions section of step13input.txt 
