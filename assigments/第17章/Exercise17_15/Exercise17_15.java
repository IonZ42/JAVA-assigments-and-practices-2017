...
public class Exercise17_15 {
	public static void main(String[] args) throws IOException,FileNotFoundException {
		...
		System.out.println("Enter the input (encrypted) file path: ");inpath=in.next();
		...
		try {
			...
			System.out.println("the file "+inpath+" has been decrypted into file "+outpath);
		} 
		catch (EOFException ex) {
			System.out.println("the file "+inpath+" has been decrypted");
		}
